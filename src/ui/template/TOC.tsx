  ...
  return (
    <div ref={ref} className="relative flex items-center justify-center h-screen">
      <div className="p-4 rounded-full shadow-xl" id="main-bag">
        <Image src={TB} alt="bag" width={radius / 3} height={radius / 3} />
      </div>
        ...
        return (
          ...
          >
            <div className="flex flex-col items-center">
              <Image src={TB} alt="" className="rounded-xl" width={innerRadius === 80 ? 35 : 45} height={innerRadius === 80 ? 35 : 45} /> {/* Smaller for mobile */}
